...
| [`Texture`](#itexturetextureid) | Gets a [`Texture`](texture) by Asset ID from the public CDN. |
| [`Texture`](#itexturepack-texturepath) | Gets a [`Texture`](texture) from a marker pack. |
<br/>
---
