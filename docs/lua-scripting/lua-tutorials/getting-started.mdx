...
### Pack Structure
If you haven't already set up your pack structure, you should do that now. You can find a guide on how to do that [here](/docs/marker-dev/tutorials/getting-started.md).
